...
class Program
{
    static void Main(string[] args)
    {
        ...
        //Third video
        video3.addComentsToList(comment.addComments("Robert","Such an inspiring talk from the leaders of The Church Of Jesus Christ"));
        video3.addComentsToList(comment.addComments("Tomiwa","I love elder Aminu very much"));
        video3.addComentsToList(comment.addComments("Anthony","Really we need to see ourselves as children of God just as the apostles has admonished us all"));
        video3.addComentsToList(comment.addComments("Adamu","I know what the prophets are saying is very true and i know we will be blessed when we follow their admonishments"));
